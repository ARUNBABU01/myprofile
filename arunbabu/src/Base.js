export const DB_HOST_URL= process.env.REACT_APP_DB_HOST_URL
export const DB_HOST_PORT = process.env.REACT_APP_DB_HOST_PORT
export const HTTP_PROTOCOL = process.env.REACT_APP_HTTP_PROTOCOL
...
export const USE_FIREBASE_DB = process.env.REACT_APP_USE_FIREBASE_DB